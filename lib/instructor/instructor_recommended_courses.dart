...
class InstructorRecommendedCourses extends StatefulWidget {
  InstructorRecommendedCourses({super.key});

  @override
  State<InstructorRecommendedCourses> createState() => _InstructorRecommendedCoursesState();
}

class _InstructorRecommendedCoursesState extends State<InstructorRecommendedCourses> {
