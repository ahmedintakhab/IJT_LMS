...
class DeleteTrueFalseQuestionDialogbox extends StatefulWidget {
  final VoidCallback onDelete;
  final VoidCallback onCancel;
  final int? quizId;

  const DeleteTrueFalseQuestionDialogbox({
    super.key,
  ...
  @override
  State<DeleteTrueFalseQuestionDialogbox> createState() => _DeleteTrueFalseQuestionDialogboxState();
}

class _DeleteTrueFalseQuestionDialogboxState extends State<DeleteTrueFalseQuestionDialogbox> {
  bool _isLoading = false;

  Future<void> _deleteLesson() async {
    if (widget.quizId == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('No question selected')),
      );
      return;
    }
    ...
    try {
      ...
      print('check quiz id for delete ${widget.quizId}');

      final url = Uri.parse('${ApiConstant.baseUrl}instructor/course/exam/delete');
  ...
  Widget build(BuildContext context) {
    print('Check the question id ${widget.quizId}');
    return Dialog(
