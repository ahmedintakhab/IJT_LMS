...
class DeleteQuizQuestionDialogbox extends StatefulWidget {
  final VoidCallback onDelete;
  final VoidCallback onCancel;
  final int? questionId;

  const DeleteQuizQuestionDialogbox({
    super.key,
  ...
  @override
  State<DeleteQuizQuestionDialogbox> createState() => _DeleteQuizQuestionDialogboxState();
}

class _DeleteQuizQuestionDialogboxState extends State<DeleteQuizQuestionDialogbox> {
  ...
  Future<void> _deleteLesson() async {
    ...
    try {
      ...
      final url = Uri.parse('${ApiConstant.baseUrl}instructor/course/exam/delete_question');
  ...
  Widget build(BuildContext context) {
    print('Check the question id ${widget.questionId}');
    return Dialog(
